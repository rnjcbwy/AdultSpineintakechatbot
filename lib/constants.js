...
export const INTAKE_STEPS = [
  ...
  { id: 'symptom-details', label: 'Symptom Details', icon: '5' },
  { id: 'treatments', label: 'Prior Treatments', icon: '6' },
  { id: 'records', label: 'Records & Documents', icon: '7' },
  { id: 'additional', label: 'Additional Details', icon: '8' },
  { id: 'pmh', label: 'Past Medical History', icon: '9' },
  { id: 'psh', label: 'Past Surgical History', icon: '10' },
  { id: 'medications', label: 'Medications', icon: '11' },
  { id: 'allergies', label: 'Allergies', icon: '12' },
  { id: 'social', label: 'Social History', icon: '13' },
  { id: 'family', label: 'Family History', icon: '14' },
  { id: 'ros', label: 'Review of Systems', icon: '15' },
  { id: 'proms', label: 'Outcome Questionnaires', icon: '16' },
  { id: 'review', label: 'Review & Submit', icon: '17' },
];
