...
export const INTAKE_STEPS = [
  ...
  { id: 'additional', label: 'Additional Details', icon: '7' },
  { id: 'pmh', label: 'Past Medical History', icon: '8' },
  { id: 'psh', label: 'Past Surgical History', icon: '9' },
  { id: 'medications', label: 'Medications', icon: '10' },
  { id: 'allergies', label: 'Allergies', icon: '11' },
  { id: 'social', label: 'Social History', icon: '12' },
  { id: 'family', label: 'Family History', icon: '13' },
  { id: 'ros', label: 'Review of Systems', icon: '14' },
  { id: 'proms', label: 'Outcome Questionnaires', icon: '15' },
  { id: 'review', label: 'Review & Submit', icon: '16' },
];
