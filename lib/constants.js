...
export const INTAKE_STEPS = [
  ...
  { id: 'consent', label: 'Before We Begin', icon: '2' },
  { id: 'demographics', label: 'Demographics', icon: '3' },
  { id: 'chief-complaint', label: 'Chief Complaint', icon: '4' },
  { id: 'pain-map', label: 'Pain Map', icon: '5' },
  { id: 'symptom-details', label: 'Symptom Details', icon: '6' },
  { id: 'treatments', label: 'Prior Treatments', icon: '7' },
  { id: 'records', label: 'Records & Documents', icon: '8' },
  { id: 'additional', label: 'Additional Details', icon: '9' },
  { id: 'pmh', label: 'Past Medical History', icon: '10' },
  { id: 'psh', label: 'Past Surgical History', icon: '11' },
  { id: 'medications', label: 'Medications', icon: '12' },
  { id: 'allergies', label: 'Allergies', icon: '13' },
  { id: 'social', label: 'Social History', icon: '14' },
  { id: 'family', label: 'Family History', icon: '15' },
  { id: 'ros', label: 'Review of Systems', icon: '16' },
  { id: 'proms', label: 'Outcome Questionnaires', icon: '17' },
  { id: 'review', label: 'Review & Submit', icon: '18' },
];
