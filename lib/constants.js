...
export const INTAKE_STEPS = [
  ...
  { id: 'symptom-details', label: 'Symptom Details', icon: '4' },
  { id: 'treatments', label: 'Prior Treatments', icon: '5' },
  { id: 'additional', label: 'Additional Details', icon: '6' },
  { id: 'pmh', label: 'Past Medical History', icon: '7' },
  { id: 'psh', label: 'Past Surgical History', icon: '8' },
  { id: 'medications', label: 'Medications', icon: '9' },
  { id: 'allergies', label: 'Allergies', icon: '10' },
  { id: 'social', label: 'Social History', icon: '11' },
  { id: 'family', label: 'Family History', icon: '12' },
  { id: 'ros', label: 'Review of Systems', icon: '13' },
  { id: 'proms', label: 'Outcome Questionnaires', icon: '14' },
  { id: 'review', label: 'Review & Submit', icon: '15' },
];
